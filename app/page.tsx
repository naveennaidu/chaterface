  ...
  return (
    <div className="flex flex-col h-screen divide-y divide-sage-4 w-full">
      <div className="w-full">
        <div className="flex flex-row items-center w-full max-w-7xl mx-auto p-4 border-x border-sage-4 justify-between">
      ...
      <div className="w-full border-b border-sage-4">
        <div className="border-x border-sage-4 max-w-7xl mx-auto">
          <div
            className="flex flex-col items-center justify-center w-full max-w-7xl mx-auto pt-40 pb-80 mx-4 relative overflow-hidden"
            style={{
